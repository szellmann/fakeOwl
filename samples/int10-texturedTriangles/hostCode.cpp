...
Viewer::Viewer()
{
  ...
  OWLBuffer vertexBuffer
    = owlBufferCreateEXT(context,OWL_FLOAT3,vertices.size(),vertices.data());
  OWLBuffer texCoordsBuffer
    = owlBufferCreateEXT(context,OWL_FLOAT2,texCoords.size(),texCoords.data());
  OWLBuffer indexBuffer
    = owlBufferCreateEXT(context,OWL_INT3,indices.size(),indices.data());

                 ...
                 const vec3i coord)
{
  ...
  OWLBuffer vertexBuffer
    = owlBufferCreateEXT(context,OWL_FLOAT3,mesh.vertices.size(),mesh.vertices.data());
  OWLBuffer texCoordsBuffer
    = owlBufferCreateEXT(context,OWL_FLOAT2,mesh.texCoords.size(),mesh.texCoords.data());
  OWLBuffer indexBuffer
    = owlBufferCreateEXT(context,OWL_INT3,mesh.indices.size(),mesh.indices.data());

...
void Viewer::resize(const vec2i &newSize)
{
  ...
  if (accumBuffer)
    ...
    accumBuffer = owlBufferCreateEXT(context,OWL_FLOAT4,
              ...
              init_fbSize)
{
  ...
  OWLBuffer metalSpheresBuffer
    = owlBufferCreateEXT(context,OWL_USER_TYPE(metalSpheres[0]),
  ...
  OWLBuffer lambertianSpheresBuffer
    = owlBufferCreateEXT(context,OWL_USER_TYPE(lambertianSpheres[0]),
  ...
  OWLBuffer dielectricSpheresBuffer
    = owlBufferCreateEXT(context,OWL_USER_TYPE(dielectricSpheres[0]),
  ...
  OWLBuffer lambertianMaterialsBuffer
    = owlBufferCreateEXT(context,OWL_USER_TYPE(lambertianBoxes.materials[0]),
  ...
  OWLBuffer dielectricMaterialsBuffer
    = owlBufferCreateEXT(context,OWL_USER_TYPE(dielectricBoxes.materials[0]),
